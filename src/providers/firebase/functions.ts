...
export class FirebaseFunctionsBuilder extends BaseBuilder {
  ...
  source(path: string)             { this._sourcePath = path; return this; }
  entryPoint(e: string)            { this._entryPoint = e; return this; }
  runtime(r: string)               { this._runtime = r; return this; }
  region(r: string)                { this._region = r; return this; }
  memory(m: string)                { this._memory = m; return this; }
  timeout(seconds: number)         { this._timeout = seconds; return this; }
  maxInstances(n: number)          { this._maxInstances = n; return this; }
  minInstances(n: number)          { this._minInstances = n; return this; }
  env(vars: Record<string, string>){ this._env = vars; return this; }
  ...
  private zipSource(): Buffer {
    if (!this._sourcePath) throw new Error(`[Firebase.Functions:${this.name}] .source() is required`);

...
(function() {
  ...
  const TYPE_LABELS = {
    ...
    'GCP.CloudRun':        'Cloud Run Services',
    'GCP.CloudSQL':        'Cloud SQL Instances',
    'GCP.CloudDNS':        'Cloud DNS Zones',
    'GCP.PubSub':          'Pub/Sub Topics',
    'GCP.Secret':          'Secrets',
    'Firebase.Hosting':    'Hosting Sites',
    'Firebase.Functions':  'Cloud Functions',
    'Firebase.Firestore':  'Firestore Databases',
    'Firebase.Storage':    'Storage Buckets',
